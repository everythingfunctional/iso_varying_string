...
contains
    ...
    pure function check_string_equal_string(input) result(result_)
    ...
    pure function check_character_equal_string(input) result(result_)
        class(input_t), intent(in) :: input
        type(result_t) :: result_
    ...
    pure function check_string_equal_character(input) result(result_)
        class(input_t), intent(in) :: input
        type(result_t) :: result_
