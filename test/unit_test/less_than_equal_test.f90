...
contains
    function test_less_than_equals() result(tests)
        ...
        tests = describe( &
                ...
                [ it( &
                        ...
                        check_string_less_than_equal_string) &
                , it( &
                        "a character and a string", &
                        ASCII_STRING_PAIR_GENERATOR, &
                        check_character_less_than_equal_string) &
                , it( &
    ...
    pure function check_string_less_than_equal_string(input) result(result_)
    ...
    pure function check_character_less_than_equal_string(input) result(result_)
        class(input_t), intent(in) :: input
        type(result_t) :: result_
    ...
    pure function check_string_less_than_equal_character(input) result(result_)
        class(input_t), intent(in) :: input
        type(result_t) :: result_
