...
contains
    subroutine run()
        ...
        use replace_target_test, only: &
            replace_target_replace_string_with_string_in_string => test_replace_string_with_string_in_string, &
            replace_target_replace_string_with_string_in_character => test_replace_string_with_string_in_character, &
            replace_target_replace_string_with_character_in_string => test_replace_string_with_character_in_string, &
            replace_target_replace_string_with_character_in_character => test_replace_string_with_character_in_character, &
            replace_target_replace_character_with_string_in_string => test_replace_character_with_string_in_string, &
            replace_target_replace_character_with_string_in_character => test_replace_character_with_string_in_character, &
            replace_target_replace_character_with_character_in_string => test_replace_character_with_character_in_string, &
            replace_target_replace_character_with_character_in_character => test_replace_character_with_character_in_character
        use scan_test, only: &
            scan_scan => test_scan
        ...
        type(TestItem_t) :: individual_tests(51)
        ...
        individual_tests(7) = extract_extract_string()
        ...
        individual_tests(14) = insert_insert_string_into_string()
        individual_tests(15) = insert_insert_string_into_character()
        individual_tests(16) = insert_insert_character_into_string()
        individual_tests(17) = insert_insert_character_into_character()
        ...
        individual_tests(27) = remove_remove_string()
        individual_tests(28) = remove_remove_character()
        individual_tests(29) = repeat_repeat()
        individual_tests(30) = replace_range_replace_string_in_string_range()
        individual_tests(31) = replace_range_replace_string_in_character_range()
        individual_tests(32) = replace_range_replace_character_in_string_range()
        individual_tests(33) = replace_range_replace_character_in_character_range()
        individual_tests(34) = replace_start_replace_string_in_string_start()
        individual_tests(35) = replace_start_replace_string_in_character_start()
        individual_tests(36) = replace_start_replace_character_in_string_start()
        individual_tests(37) = replace_start_replace_character_in_character_start()
        individual_tests(38) = replace_target_replace_string_with_string_in_string()
        individual_tests(39) = replace_target_replace_string_with_string_in_character()
        individual_tests(40) = replace_target_replace_string_with_character_in_string()
        individual_tests(41) = replace_target_replace_string_with_character_in_character()
        individual_tests(42) = replace_target_replace_character_with_string_in_string()
        individual_tests(43) = replace_target_replace_character_with_string_in_character()
        individual_tests(44) = replace_target_replace_character_with_character_in_string()
        individual_tests(45) = replace_target_replace_character_with_character_in_character()
