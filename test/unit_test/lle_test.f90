...
contains
    ...
    pure function check_string_lle_string(input) result(result_)
        ...
        type is (string_pair_input_t)
            result_ = assert_that( &
                    lle(char(input%first()), char(input%second())) &
                    .eqv. lle(input%first(), input%second()), &
                    'lle("' // input%first() // '", "' // input%second() // '")')
        class default
            result_ = fail("Expected to get a string_pair_input_t")
        end select
    end function

    pure function check_character_lle_string(input) result(result_)
        class(input_t), intent(in) :: input
        type(result_t) :: result_
        ...
        type is (string_pair_input_t)
            result_ = assert_that( &
                    lle(char(input%first()), char(input%second())) &
                    .eqv. lle(char(input%first()), input%second()), &
                    'lle("' // input%first() // '", "' // input%second() // '")')
        class default
            result_ = fail("Expected to get a string_pair_input_t")
        end select
    ...
    pure function check_string_lle_character(input) result(result_)
        class(input_t), intent(in) :: input
        type(result_t) :: result_
        ...
        type is (string_pair_input_t)
            result_ = assert_that( &
                    lle(char(input%first()), char(input%second())) &
                    .eqv. lle(input%first(), char(input%second())), &
                    'lle("' // input%first() // '", "' // input%second() // '")')
        class default
            result_ = fail("Expected to get a string_pair_input_t")
        end select
