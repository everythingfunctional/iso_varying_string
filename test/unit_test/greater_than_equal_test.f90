...
contains
    function test_greater_than_equals() result(tests)
        ...
        tests = describe( &
                ...
                [ it( &
                        ...
                        check_string_greater_than_equal_string) &
                , it( &
                        "a character and a string", &
                        ASCII_STRING_PAIR_GENERATOR, &
                        check_character_greater_than_equal_string) &
                , it( &
                        "a string and a character", &
                        ASCII_STRING_PAIR_GENERATOR, &
                        check_string_greater_than_equal_character) &
                ])
    end function

    pure function check_string_greater_than_equal_string(input) result(result_)
    ...
    pure function check_character_greater_than_equal_string(input) result(result_)
        class(input_t), intent(in) :: input
        type(result_t) :: result_
    ...
    pure function check_string_greater_than_equal_character(input) result(result_)
        class(input_t), intent(in) :: input
        type(result_t) :: result_
